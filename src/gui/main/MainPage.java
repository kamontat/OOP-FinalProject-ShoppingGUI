...
public class MainPage extends JFrame implements ButtonFactory {
	...
	private static FileFactory factory = FileFactory.getInstance();
	...
	public static void reWriteCustomer() {
		factory.overwrite(TextFile.CUSTOMER, store.getAllCustomer());
	}
	...
	public static void reWriteProductInfo() {
		factory.overwrite(TextFile.PRODUCT, store.getAllProduct(false));
	}
	...
	public static void reWriteStoreInfo() {
		factory.overwrite(TextFile.STORE_INFORMATION, new Object[][]{{store.getRevenue(), store.getExpense()}});
	}
	...
	private static ArrayList<ProductExt> assignProduct() {
		...
		ArrayList<String[]> allProduct = factory.readText(TextFile.PRODUCT);
	...
	private static ArrayList<Customer> assignCustomer() {
		...
		ArrayList<String[]> allCustomer = factory.readText(TextFile.CUSTOMER);
	...
	private static Store assignStore() {
		...
		Store temp = null;
		ArrayList<String[]> information = factory.readText(TextFile.STORE_INFORMATION);
